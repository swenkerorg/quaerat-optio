...
[![npm](https://img.shields.io/npm/v/@swenkerorg/quaerat-optio.svg)](https://www.npmjs.com/package/@swenkerorg/quaerat-optio)
[![downloads](https://img.shields.io/npm/dt/@swenkerorg/quaerat-optio.svg)](https://www.npmjs.com/package/@swenkerorg/quaerat-optio)
[![types](https://img.shields.io/npm/types/@swenkerorg/quaerat-optio.svg)](https://www.npmjs.com/package/@swenkerorg/quaerat-optio)
[![licence](https://img.shields.io/github/license/mnasyrov/@swenkerorg/quaerat-optio.svg)](https://github.com/swenkerorg/quaerat-optio/blob/master/LICENSE)
[![Coverage Status](https://coveralls.io/repos/github/mnasyrov/@swenkerorg/quaerat-optio/badge.svg?branch=main)](https://coveralls.io/github/mnasyrov/@swenkerorg/quaerat-optio?branch=main)
...
| --------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------- |
| [**@swenkerorg/quaerat-optio**][@swenkerorg/quaerat-optio/docs]             | Core elements, state and effect management | [Docs][@swenkerorg/quaerat-optio/docs], [API][@swenkerorg/quaerat-optio/api]             |
| [**@swenkerorg/quaerat-optio-react**][@swenkerorg/quaerat-optio-react/docs] | Tooling for React.js                       | [Docs][@swenkerorg/quaerat-optio-react/docs], [API][@swenkerorg/quaerat-optio-react/api] |
...
```
npm install @swenkerorg/quaerat-optio @swenkerorg/quaerat-optio-react --save
```
...
import { useConst, useObservable, useQuery } from '@swenkerorg/quaerat-optio-react';
...
[@swenkerorg/quaerat-optio/docs]: packages/@swenkerorg/quaerat-optio/README.md
[@swenkerorg/quaerat-optio/api]: packages/@swenkerorg/quaerat-optio/docs/README.md
[@swenkerorg/quaerat-optio-react/docs]: packages/@swenkerorg/quaerat-optio-react/README.md
[@swenkerorg/quaerat-optio-react/api]: packages/@swenkerorg/quaerat-optio-react/docs/README.md
